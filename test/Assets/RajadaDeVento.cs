...
public class RajadaDeVento : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            slot1.transform.GetChild(0).gameObject.GetComponent<cardAtk>().Def -= 200;

        }
        if (slot2.transform.childCount != 0)
        {
            slot2.transform.GetChild(0).gameObject.GetComponent<cardAtk>().Def -= 200;

        }
        if (slot3.transform.childCount != 0)
        {
            slot3.transform.GetChild(0).gameObject.GetComponent<cardAtk>().Def -= 200;

        }
        if (slot4.transform.childCount != 0)
        {
            slot4.transform.GetChild(0).gameObject.GetComponent<cardAtk>().Def -= 200;

        }
        if (slot5.transform.childCount != 0)
        {
            slot5.transform.GetChild(0).gameObject.GetComponent<cardAtk>().Def -= 200;

        }
        if (slot6.transform.childCount != 0)
        {
            slot6.transform.GetChild(0).gameObject.GetComponent<cardAtk>().Def -= 200;
